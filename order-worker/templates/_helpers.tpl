...
helm.sh/chart: {{ include "order-worker.chart" . }}
{{ include "order-worker.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
app.kubernetes.io/name: {{ include "order-worker.name" . }}
